...
```
Trip (id, name, createdAt, updatedAt)
  └─ Hotel[] (id, tripId, name, notes, latitude, longitude, createdAt, updatedAt)
...
|---|---|---|---|---|
| Google Maps | `compass/google-maps-reviews-scraper` | ja | ~$0.001 | `maxReviews: 1`, liefert `location.lat/lng` mit |
...
- Reisen haben nur ein Namensfeld, kein Datumsbereich (bewusst einfach gehalten).
