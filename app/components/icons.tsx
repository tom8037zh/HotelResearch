...
/**
 * Handgezeichnete Icons aus dem Redesign-Handoff (design/design_handoff_hotel_research_redesign).
 * Pfade bewusst 1:1 aus den .dc.html-Referenzdateien übernommen statt einer Icon-Bibliothek, um den
 * exakten Look zu erhalten.
 */
